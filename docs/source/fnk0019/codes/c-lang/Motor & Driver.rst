...
1.	Use ``cd`` command to enter 11.1.1_Motor directory of the C code.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/C_Code/11.1.1_Motor
...
.. literalinclude:: ../../../freenove_Kit/Code/C_Code/11.1.1_Motor/Motor.cpp
    :linenos: 
    :language: C
    :dedent:
