...
1.	Use ``cd`` command to enter 13.1.1_SevenSegmentDisplay directory of C code.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/C_Code/13.1.1_SevenSegmentDisplay
...
.. literalinclude:: ../../../freenove_Kit/Code/C_Code/13.1.1_SevenSegmentDisplay/SevenSegmentDisplay.c
    :linenos: 
    :language: C
    :dedent:
