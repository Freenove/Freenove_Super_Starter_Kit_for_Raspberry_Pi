...
1.	Use ``cd`` command to enter ``15.1.1_ I2CLCD1602`` directory of C code.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/C_Code/15.1.1_I2CLCD1602
...
.. literalinclude:: ../../../freenove_Kit/Code/C_Code/15.1.1_I2CLCD1602/I2CLCD1602.c
    :linenos: 
    :language: C
