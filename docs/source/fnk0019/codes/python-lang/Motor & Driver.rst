...
1.	Use cd command to enter 11.1.1_Motor directory of Python code.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/Python_GPIOZero_Code/11.1.1_Motor
...
.. literalinclude:: ../../../freenove_Kit/Code/Python_GPIOZero_Code/11.1.1_Motor/Motor.py
    :linenos: 
    :language: python
