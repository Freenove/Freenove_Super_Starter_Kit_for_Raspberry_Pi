...
1.	Use ``cd`` command to enter 15.1.1_I2CLCD1602 directory of Python code.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/Python_GPIOZero_Code/15.1.1_I2CLCD1602
...
.. literalinclude:: ../../../freenove_Kit/Code/Python_GPIOZero_Code/15.1.1_I2CLCD1602/I2CLCD1602.py
    :linenos: 
    :language: python
    :dedent:
