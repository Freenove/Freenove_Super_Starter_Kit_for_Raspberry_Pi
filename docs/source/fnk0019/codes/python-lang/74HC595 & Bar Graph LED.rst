...
1.	Use cd command to enter 12.1.1_LightWater02 directory of Python code.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/Python_GPIOZero_Code/12.1.1_LightWater02
...
.. literalinclude:: ../../../freenove_Kit/Code/Python_GPIOZero_Code/12.1.1_LightWater02/LightWater02.py
    :linenos: 
    :language: python
