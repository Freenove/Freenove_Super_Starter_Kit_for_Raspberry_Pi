...
1.	Use cd command to enter 13.1.1_SevenSegmentDisplay directory of Python code.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/Python_GPIOZero_Code/13.1.1_SevenSegmentDisplay
...
.. literalinclude:: ../../../freenove_Kit/Code/Python_GPIOZero_Code/13.1.1_SevenSegmentDisplay/SevenSegmentDisplay.py
    :linenos: 
    :language: python
