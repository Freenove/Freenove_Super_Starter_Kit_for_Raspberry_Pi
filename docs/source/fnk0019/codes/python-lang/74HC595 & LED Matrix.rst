...
1.	Use ``cd`` command to enter 14.1.1_LEDMatrix directory of Python language.

.. code-block:: console

    $ cd ~/Freenove_Kit/Code/Python_GPIOZero_Code/14.1.1_LEDMatrix
...
.. literalinclude:: ../../../freenove_Kit/Code/Python_GPIOZero_Code/14.1.1_LEDMatrix/LEDMatrix.py
    :linenos: 
    :language: python
    :dedent:
